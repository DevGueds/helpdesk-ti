...
function createApp() {
  ...
  app.use(
    helmet({
      hsts: false, // Desabilitado: app roda em HTTP puro (sem HTTPS)
      crossOriginOpenerPolicy: false, // Evita warning de COOP em HTTP
      originAgentCluster: false, // Evita warning de Origin-Agent-Cluster em HTTP
  ...
  app.get("/", (req, res) => {
    ...
    if (req.user.role === "COORDINATOR")
      return res.redirect("/coordinator/tickets");
